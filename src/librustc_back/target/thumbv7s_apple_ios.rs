...
pub fn target() -> Target {
    Target {
        data_layout: "e-p:32:32-i1:32:32-i8:32:32-i16:32:32-f64:32:32-v64:32:64-v128:32:128-a:0:32-n32-S32".to_string(),
        llvm_target: "thumbv7s-apple-ios".to_string(),
        target_endian: "little".to_string(),
        target_word_size: "32".to_string(),
        arch: "arm".to_string(),
        target_os: "ios".to_string(),
        options: TargetOptions {
            features: "+v7,+thumb2,+vfp4,+neon".to_string(),
            executables: true,
