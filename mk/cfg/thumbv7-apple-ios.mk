...
CFG_IOS_SDK_thumbv7-apple-ios = :$(shell xcrun --show-sdk-path -sdk iphoneos 2>/dev/null)
CFG_IOS_SDK_FLAGS_thumbv7-apple-ios := -target thumbv7-apple-ios -isysroot $(CFG_IOS_SDK_thumbv7-apple-ios) -mios-version-min=7.0
...
CFG_JEMALLOC_CFLAGS_thumbv7-apple-ios := -arch armv7 -mfpu=vfp3 $(CFG_IOS_SDK_FLAGS_thumbv7-apple-ios)
CFG_GCCISH_CFLAGS_thumbv7-apple-ios := -Wall -Werror -g -fPIC $(CFG_IOS_SDK_FLAGS_thumbv7-apple-ios) -mfpu=vfp3 -arch armv7
CFG_GCCISH_CXXFLAGS_thumbv7-apple-ios := -fno-rtti $(CFG_IOS_SDK_FLAGS_thumbv7-apple-ios) -I$(CFG_IOS_SDK_thumbv7-apple-ios)/usr/include/c++/4.2.1
CFG_GCCISH_LINK_FLAGS_thumbv7-apple-ios := -lpthread -syslibroot $(CFG_IOS_SDK_thumbv7-apple-ios) -Wl,-no_compact_unwind
...
CFG_LLC_FLAGS_thumbv7-apple-ios := -mattr=+vfp3,+v7,+thumb2,+neon
