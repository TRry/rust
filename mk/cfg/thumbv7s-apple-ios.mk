...
CFG_IOS_SDK_thumbv7s-apple-ios := $(shell xcrun --show-sdk-path -sdk iphoneos 2>/dev/null)
CFG_IOS_SDK_FLAGS_thumbv7s-apple-ios := -target thumbv7s-apple-ios -isysroot $(CFG_IOS_SDK_thumbv7s-apple-ios) -mios-version-min=7.0
...
CFG_JEMALLOC_CFLAGS_thumbv7s-apple-ios := -arch armv7 -mfpu=vfp4 $(CFG_IOS_SDK_FLAGS_thumbv7s-apple-ios)
CFG_GCCISH_CFLAGS_thumbv7s-apple-ios := -Wall -Werror -g -fPIC $(CFG_IOS_SDK_FLAGS_thumbv7s-apple-ios) -mfpu=vfp3 -arch armv7
CFG_GCCISH_CXXFLAGS_thumbv7s-apple-ios := -fno-rtti $(CFG_IOS_SDK_FLAGS_thumbv7s-apple-ios) -I$(CFG_IOS_SDK_thumbv7s-apple-ios)/usr/include/c++/4.2.1
CFG_GCCISH_LINK_FLAGS_thumbv7s-apple-ios := -lpthread -syslibroot $(CFG_IOS_SDK_thumbv7s-apple-ios) -Wl,-no_compact_unwind
...
CFG_LLC_FLAGS_thumbv7s-apple-ios := -mattr=+vfp4,+v7,+thumb2,+neon
